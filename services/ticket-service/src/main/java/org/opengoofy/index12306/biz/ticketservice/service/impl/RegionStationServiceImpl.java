...
public class RegionStationServiceImpl implements RegionStationService {
    ...
    @Override
    public List<RegionStationQueryRespDTO> listRegionStations(RegionStationQueryReqDTO requestParam) {
        if (StrUtil.isNotBlank(requestParam.getName())) {
            String key = REGION_STATION + requestParam.getName();
            return safeGetRegionStations(
                    key,
                    () -> {
        ...
        String key = REGION_STATION + requestParam.getQueryType();
    ...
    private List<RegionStationQueryRespDTO> safeGetRegionStations(String key, CacheLoader<String> loader, String param) {
